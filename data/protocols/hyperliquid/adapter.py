#!/usr/bin/env python3
"""
Hyperliquid 专属适配器 — data/protocols/hyperliquid/adapter.py
...
注意：协议目录 id 为 hyperliquid，但 data/all-protocols.json 中的 protocols key 为 `hype`
...
if __name__ == "__main__":
    snap = build_snapshot(BASE_DIR / "data" / "protocols" / "hyperliquid")
