...
PLAN = {
    ...
    "aster": {
        ...
        "rr": {
            ...
            "calculation": {"payout_ratio": 0.99, "note": "99% 手续费回购给质押者（TWAP 回购 ASTER → veASTER）"},
            "source_type": "chain",
    ...
    "hype": {
        ...
        "rr": {
            ...
            "calculation": {"payout_ratio": 0.99, "note": "以链上实际销毁为准（spot 销毁地址）"},
            "source_type": "chain",
    ...
    "uniswap": {
        ...
        "rr": {
            ...
            "revenue_excluded": {},
            "calculation": {"payout_ratio": 1.0, "note": "Firepit 销毁 = 回购性质；365d 0xdead 累计口径"},
            "source_type": "chain",
    ...
    "sky": {
        ...
        "rr": {
            ...
            "calculation": {"payout_ratio": 0.3336, "note": "Elixir 燃烧/留存口径"},
    ...
    "pendle": {
        ...
        "rr": {
            ...
            "revenue_excluded": {},
            "calculation": {"payout_ratio": 0.80, "note": "sPENDLE 时代 2026-01-29 起链上可验证"},
            "source_type": "chain",
    ...
    "dydx": {
        ...
        "rr": {
            ...
            "revenue_excluded": {},
            "calculation": {"payout_ratio": 0.75, "note": "回购(质押非销毁)，存 Treasury 专用账户；质押奖励 ~0.01% APY 极低；交易所已更名 Arcus，DYDX 代币未更名"},
            "source_type": "official",
    ...
    "gmx": {
        ...
        "rr": {
            ...
            "calculation": {"revenue_usd_365d": "扣 LP → 净利 → 留存 27%", "payout_ratio": 0.0,
    ...
    "pancakeswap": {
        ...
        "rr": {
            ...
            "revenue_excluded": {},
            "calculation": {"payout_ratio": 0.625, "note": "按 60-65% 计入 🟢（现有 payout_ratio 0.15 低估已更新）；现货 15-23%、永续 20%、CAKE.PAD 100%"},
            "source_type": "official",
    ...
    "maple": {
        ...
        "rr": {
            ...
            "revenue_excluded": {},
            "calculation": {"payout_ratio": 0.10, "note": "动态阶梯：2026-07 起按 MIP-021；MIP-019/020 固定 25% 已于 2026-Q2 结束"},
            "source_type": "official",
    ...
    "ethena": {
        ...
        "rr": {
            ...
            "calculation": {"payout_ratio": 0.0, "note": "近 12 月收入 ~$310M 但净利仅 ~$0.6M；费用开关是 AI 哨兵观察点"},
            "source_type": "official",
    ...
    "justlend": {
        ...
        "rr": {
            ...
            "calculation": {"payout_ratio": 0.0, "note": "TEV=0"},
            "source_type": "estimate",
            "source_url": None,
        },
        "dp": {
    ...
    "lido": {
        ...
        "rr": {
            ...
            "revenue_excluded": {},
            "calculation": {"payout_ratio": 0.0, "note": "LDO 仅治理；不回购的钱进国库/支出 → 损益表留存行"},
            "source_type": "defillama",
    ...
    "eigenlayer": {
        ...
        "rr": {
            ...
            "revenue_included": {"protocol_fees": {"note": "DefiLlama dailyRevenue（协议归属部分）"}},
            "revenue_excluded": {},
            "calculation": {"payout_ratio": 0.0, "note": "EIGEN 无收益权；不回购的钱进国库/支出 → 留存行"},
            "source_type": "defillama",
    ...
    "compound": {
        ...
        "rr": {
            ...
            "revenue_included": {"protocol_fees": {"note": "DefiLlama dailyRevenue（协议归属部分）"}},
            "revenue_excluded": {},
            "calculation": {"payout_ratio": 0.0, "note": "不回购的钱进国库/支出 → 留存行"},
            "source_type": "defillama",
    ...
    "spark": {
        ...
        "rr": {
            ...
            "revenue_included": {"protocol_fees": {"note": "DefiLlama dailyRevenue（协议归属部分）"}},
            "revenue_excluded": {},
            "calculation": {"payout_ratio": 0.0, "note": "收入流向 Sky DAO，SPK 本身无股东回报"},
            "source_type": "defillama",
    ...
    "fluid": {
        ...
        "rr": {
            ...
            "revenue_included": {"protocol_fees": {"note": "DefiLlama dailyRevenue（协议归属部分）"}},
            "revenue_excluded": {},
            "calculation": {"payout_ratio": 0.35, "note": "35% 回购口径（DefiLlama dailyHoldersRevenue 365d $4.75M 与官方 35% 一致）"},
            "source_type": "defillama",
